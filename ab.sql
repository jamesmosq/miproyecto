...
-- Volcando estructura para tabla northwind.employeeactions
CREATE TABLE IF NOT EXISTS `employeeactions` (
  ...
  CONSTRAINT `employeeactions_ibfk_1` FOREIGN KEY (`EmployeeID`) REFERENCES `employees` (`EmployeeID`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla northwind.employeeactions: ~8 rows (aproximadamente)
INSERT INTO `employeeactions` (`ActionID`, `EmployeeID`, `LastName`, `FirstName`, `ActionTime`, `ConsultDate`, `Action`) VALUES
	(1, 1, 'Davolio', 'Nancy', '2024-08-31 08:50:58', NULL, 'REFRIGERIO'),
	(2, 3, 'Leverling', 'Janet', '2024-08-31 08:51:34', NULL, 'REFRIGERIO'),
	(3, 9, 'Dodsworth', 'Anne', '2024-08-31 08:51:54', NULL, 'REFRIGERIO'),
	(4, 3, 'Leverling', 'Janet', '2024-08-31 08:52:06', NULL, 'REFRIGERIO'),
	(5, 3, 'Leverling', 'Janet', '2024-08-31 08:55:26', '2024-08-31', 'REFRIGERIO'),
	(6, 3, 'Leverling', 'Janet', '2024-08-31 08:55:32', '2024-08-31', 'REFRIGERIO'),
	(7, 5, 'Buchanan', 'Steven', '2024-08-31 08:56:26', '2024-08-31', 'REFRIGERIO'),
	(8, 5, 'Buchanan', 'Steven', '2024-08-31 08:56:35', '2024-08-31', 'REFRIGERIO'),
	(9, 5, 'Buchanan', 'Steven', '2024-08-31 08:56:40', '2024-08-31', 'REFRIGERIO');
...
-- Volcando estructura para procedimiento northwind.GetEmployeeAndLogAction
DELIMITER //
CREATE PROCEDURE `GetEmployeeAndLogAction`(IN emp_id INT)
BEGIN
    DECLARE employee_lastname VARCHAR(15);
    DECLARE employee_firstname VARCHAR(15);
    DECLARE action_type VARCHAR(20);
    
    -- Obtener los datos del empleado
    SELECT LastName, FirstName 
    INTO employee_lastname, employee_firstname
    FROM Employees 
    ...
    ELSEIF CURRENT_TIME() BETWEEN '12:00:00' AND '13:30:00' THEN
        SET action_type = 'ALMUERZO';
    ELSEIF CURRENT_TIME() BETWEEN '17:00:00' AND '18:00:00' THEN
        SET action_type = 'CENA';
    END IF;
    
    -- Insertar en la tabla de respaldo
    INSERT INTO EmployeeActions (EmployeeID, LastName, FirstName, ActionTime, ConsultDate, Action)
    VALUES (emp_id, employee_lastname, employee_firstname, NOW(), CURDATE(), action_type);
    
    -- Devolver los datos del empleado
    SELECT EmployeeID, LastName, FirstName, action_type AS Action, CURDATE() AS ConsultDate
    FROM Employees
    WHERE EmployeeID = emp_id;
END//
DELIMITER ;
